...
\begin{frame}{Existing Solutions Limited in Bit Precision}
    ...
    \note<3-3>[item]{And as you may have noticed, this traditional approach requires converting these digitally stored numbers into the analog domain, and photonic devices aren't  actually good at precisely represent these analog values because they're prone to fabrication and environmental perturbations. As a result, these methods are often limited in bit precision that they can achieve.}
\end{frame}
