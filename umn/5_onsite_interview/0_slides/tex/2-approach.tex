...
\begin{frame}{``Going Fast by Going (Wide and) Slow''}
    ...
    \note<4-4>[item]{And what I was able to achieve, through the exploration of this design space, is to improve this metric by two orders of magnitude. And there were two key factors that contributed to this improvement.}
    \note<5-5>[item]{One is the use of a moderate data rate per channel, of which we found a sweet spot to be between 16 and 32 Gb/s, which really saves energy from the electronic driver and receiver circuitry; and the second is to really increase the number of parallel wavelength channels we can have in one link, from today's 8 to 16, to something like 64 and beyond.}
