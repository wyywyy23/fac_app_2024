...
\begin{frame}{96\,Tb/s Multi-Chip Package}
    ...
    \end{center}%
    \note<1-1>[item]{So, here's what the MCP looks like. And I actually have one here, so you can get an idea of how large, or small it is.}
...
\begin{frame}{Looking Under the Hood}
    ...
    \only<1-1|handout:0>{\centering\includegraphics[width=\textwidth]{fig/assembly-1_compressed.pdf}}%
    \only<2-2>{\centering\includegraphics[width=\textwidth]{fig/assembly-2_compressed.pdf}}%
...
\begin{frame}{Photonic Chiplet Design}
    ...
    \note<1-1>[item]{Each photonic chiplet has a footprint of roughly 8 by 8 mm squared, and it contains a total of 16 transmitter links and 16 receiver links. Each link has the 4 by 16 architecture that I showed earlier, and delivers 1 Tb/s bandwidth.}
