...
\begin{frame}{AI Applications Driving Explosive Growth}
    ...
    \note<2-2>[item]{As we can see here, the size of AI models has been growing nearly an order of magnitude per year over the past six to eight years, and the largest model has already exceeded 100 trillion parameters.}
