...
\begin{frame}{Automated Channel Calibration}
    ...
    \note<2-2>[item]{As a result, by tuning one microresonator across its tuning range, what you'll get from the monitoring port is a trace that records the optical power from multiple comb lines that you crossed over, but it's hard to tell which comb line is the target one.}
